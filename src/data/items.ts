...
const generateIconUrl = (id: string, name: string): string => {
  const idNum = ITEM_ID_MAP[id];
  const nameForFandom = getItemFandomName(id);

  if (idNum) {
    return `https://akm-img-a-ms.akamaized.net/image/mobile-legends/item/${idNum}.png`;
  }
  
  return `https://mobile-legends.fandom.com/wiki/Special:FilePath/${nameForFandom}.png`;
};
...
const _RAW_ITEMS: Omit<Item, 'iconUrl'>[] = [
  ...
  // --- ATTACCO FISICO ---
  {
    ...
    name: 'Frantuma Cieli',
    category: 'Attack',
    attributes: ['+60 Attacco Adattivo', '+15 Penetrazione Adattiva', '+5% Velocità di Movimento'],
  ...
  },
  {
    ...
    category: 'Attack',
    attributes: ['+80 Attacco Fisico', '+25% Velocità d\'Attacco'],
  ...
  },
  {
    ...
    category: 'Attack',
    attributes: ['+45 Attacco Fisico', '+25% Velocità d\'Attacco', '+15% Probabilità Critico'],
  ...
  },
  {
    ...
    passiveName: 'Supreme Warrior',
    passiveDescription: 'Dopo aver usato l\'Ultimate, aumenta la velocità di movimento del 15% per 7.5 secondi.'
  },
  {
    id: 'blade_of_despair',
  ...
  },
  {
    ...
    category: 'Attack',
    attributes: ['+65 Attacco Fisico', '+250 PV', '+10% Riduzione Ricarica', '+8% Rubavita Ibrido', '+5% Velocità Movimento'],
  ...
  },
  {
    ...
    category: 'Attack',
    attributes: ['+65 Attacco Fisico', '+25% Probabilità Critico', '+40% Danno Critico'],
    passiveName: 'Arrabbiato',
    passiveDescription: 'I colpi critici aumentano l\'Attacco Fisico del 5% per 2 secondi.'
  },
  {
    id: 'malefic_roar',
    name: 'Ruggito Malefico',
    category: 'Attack',
    attributes: ['+60 Attacco Fisico', '+20% Penetrazione Fisica'],
  ...
  },
  {
    ...
    category: 'Attack',
    attributes: ['+35 Attacco Fisico', '+25% Velocità d\'Attacco'],
  ...
  },
  {
    ...
    category: 'Attack',
    attributes: ['+30 Attacco Fisico', '+35% Velocità d\'Attacco', '+5% Velocità Movimento'],
  ...
  },
  {
    ...
    name: 'Scettro Dorato',
    category: 'Attack',
    attributes: ['+65 Attacco Fisico', '+15% Velocità d\'Attacco'],
    passiveName: 'Swift',
  ...
  },
  {
    ...
    category: 'Attack',
    attributes: ['+80 Attacco Fisico', '+10% Riduzione Ricarica', '+15 Penetrazione Fisica'],
    passiveName: 'Taglio Netto',
    passiveDescription: 'Colpire un eroe 5 volte aumenta la velocità di movimento del 50%.'
  },
  {
    id: 'heptaseas',
    name: 'Lama dei 7 Mari',
    category: 'Attack',
    attributes: ['+70 Attacco Fisico', '+250 PV', '+15 Penetrazione Fisica'],
  ...
  },
  {
    ...
    category: 'Attack',
    attributes: ['+35 Attacco Fisico', '+550 PV', '+10% Riduzione Ricarica', '+12% Rubavita Incantesimo'],
  ...
  },
  {
    ...
    category: 'Attack',
    attributes: ['+60 Attacco Fisico', '+30 Difesa Magica', '+10% Rubavita Fisico'],
  ...
  },
  {
    ...
    category: 'Attack',
    attributes: ['+30 Attacco Fisico', '+20% Probabilità Critico', '+25% Rubavita Fisico'],
  ...
  },
  {
    ...
    category: 'Attack',
    attributes: ['+40% Velocità d\'Attacco', '+20 Velocità di Movimento', '+10% Probabilità Critico'],
    passiveName: 'Tifone',
  ...
  // --- MAGIA ---
  {
    ...
    category: 'Magic',
    attributes: ['+70 Potere Magico', '+10% Riduzione Ricarica'],
  ...
  },
  {
    ...
    name: 'Spada Divina',
    category: 'Magic',
    attributes: ['+60 Potere Magico', '+40% Penetrazione Magica'],
  ...
  },
  {
    ...
    category: 'Magic',
    attributes: ['+45 Potere Magico', '+400 PV', '+800 Mana'],
    passiveName: 'Destino',
  ...
  },
  {
    ...
    category: 'Magic',
    attributes: ['+75 Potere Magico', '+400 PV', '+5% Velocità di Movimento'],
    passiveName: 'Scorch',
    passiveDescription: 'Brucia il nemico per 3 secondi infliggendo danni costanti e riducendo le cure ricevute.'
  },
  {
    id: 'starlium_scythe',
    name: 'Falce Starlium',
    category: 'Magic',
    attributes: ['+70 Potere Magico', '+10% Riduzione Ricarica', '+8% Rubavita Ibrido', '+6 Rigenerazione Mana'],
  ...
  },
  {
    ...
    category: 'Magic',
    attributes: ['+75 Potere Magico', '+5% Velocità di Movimento', '+10 Penetrazione Magica'],
    passiveName: 'Magic',
  ...
  },
  {
    ...
    category: 'Magic',
    attributes: ['+70 Potere Magico', '+700 PV', '+20% Rubavita Magico'],
  ...
  },
  {
    ...
    category: 'Magic',
    attributes: ['+75 Potere Magico', '+10% Rubavita Magico', '+150 Mana', '+7% Velocità Movimento'],
  ...
  },
  {
    ...
    category: 'Magic',
    attributes: ['+50 Potere Magico', '+250 PV', '+20% Riduzione Ricarica'],
  ...
  },
  {
    ...
    name: 'Ali di Sangue',
    category: 'Magic',
    attributes: ['+90 Potere Magico', '+500 PV', '+5% Velocità di Movimento'],
    passiveName: 'Guardia',
  ...
  },
  {
    ...
    category: 'Magic',
    attributes: ['+45 Attacco Adattivo', '+25 Difesa Fisica', '+400 PV'],
    passiveName: 'Nessuna',
  ...
  },
  {
    ...
    category: 'Magic',
    attributes: ['+55 Potere Magico', '+30% Velocità d\'Attacco', '+5% Riduzione Ricarica'],
  ...
  },
  {
    ...
    category: 'Defense',
    attributes: ['+40 Attacco Adattivo', '+600 PV', '+10% Riduzione Ricarica', '+10% Rubavita Incantesimo'],
  ...
  // --- SUPPORT / ROAMING / JUNGLE ---
  {
    ...
    category: 'Magic',
    attributes: ['+60 Potere Magico', '+300 PV', '+10% Riduzione Ricarica', '+12% Abilità di Cura'],
    passiveName: 'Blessing',
