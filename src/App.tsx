...
const MetaTab = lazy(() => import('./components/Tabs/MetaTab'));
const GuidePage = lazy(() => import('./components/GuidePage'));
const CountersPage = lazy(() => import('./components/CountersPage'));
const SavedTab = lazy(() => import('./components/Tabs/SavedTab'));
...
Generato e simulato su: ${window.location.href}
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-300 font-sans flex flex-col lg:flex-row pb-20 lg:pb-0">
      ...
      <Suspense fallback={
        <div className="w-full h-full flex flex-col items-center justify-center p-20 text-slate-500">
          <Loader2 size={48} className="animate-spin text-rose-500 mb-4" />
          <p className="animate-pulse">Caricamento modulo...</p>
        </div>
      }>
        ...
        {currentTab === "meta" && (
          <div className="w-full animate-fadeIn">
            <MetaTab 
              ...
              metaRoleFilter={metaRoleFilter}
              setMetaRoleFilter={setMetaRoleFilter}
              metaSort={metaSort}
              setMetaSort={setMetaSort}
              metaSortDirection={metaSortDirection}
              setMetaSortDirection={setMetaSortDirection}
              filteredAndSortedMeta={filteredAndSortedMeta}
              selectedMetaHero={selectedMetaHero}
              setSelectedMetaHero={setSelectedMetaHero}
              calculateMetaScore={calculateMetaScore}
            />
          </div>
        )}
      </Suspense>
